...
def gengtk2colors(filename,opts):
    ...
    lines="""
#
# Generated by MotifColors.py/cdepanel.py for palette {opts.currentpalettefile}
...
#hier  20221104 test font gtk
#gevonden met gtk3-widget-factory > inspector > css
#maar niet op 18.04
#font-size mochten geen "" om 
...
def updateThemeImages(opts):
    ...
    #image fragments of buttons and such for gtk2 pixmap engine
    gtk2resourcedir=os.path.join(Globals.themedir,'img2')
    gtk2resourcefile=os.path.join(gtk2resourcedir,'resource.indexed.png')
    print gtk2resourcefile
    motifcolors=Globals.colorshash

    #the resource file with the image snippets contains only these colors 
    #from the broica palette. Replace them here with the ones from the current palette
    colormap =[     
        ['#000100','fg_color_5'], 
        ['#69605b','bs_color_5'], 
        ['#a9988d','sel_color_5'], 
